package com.manuni.quizme.SpinWheel;
...
public class LuckyWheelView extends RelativeLayout implements com.manuni.quizme.SpinWheel.PielView.PieRotateListener {
    ...
    public com.manuni.quizme.SpinWheel.PielView pielView;
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mTopTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextSize, (int) com.manuni.quizme.SpinWheel.LuckyWheelUtils.convertDpToPixel(25f, getContext()));
            mSecondaryTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwSecondaryTextSize, (int) com.manuni.quizme.SpinWheel.LuckyWheelUtils.convertDpToPixel(10f, getContext()));
            mTextColor = typedArray.getColor(R.styleable.LuckyWheelView_lkwTopTextColor, 0);
            mTopTextPadding = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextPadding, (int) com.manuni.quizme.SpinWheel.LuckyWheelUtils.convertDpToPixel(22f, getContext())) + (int) com.manuni.quizme.SpinWheel.LuckyWheelUtils.convertDpToPixel(15f, getContext());
    ...
    private boolean isPielView(View view) {
        ...
        return view instanceof com.manuni.quizme.SpinWheel.PielView;
    }
    ...
    public void setData(List<com.manuni.quizme.SpinWheel.model.LuckyItem> data) {
